...
public:
	Button(const string& info, const Vector2u& window, const int& y_indent)
	{
		...
		switch (mapping[info]) {
		case 1: info1 = L"Add vertex";  break;
		case 2: info1 = L"Add edge";    break;
		case 3: info1 = L"Delete"; break;
		case 4: info1 = L"Commi";  break;
		case 5: info1 = L"confirm";  break;
		}
