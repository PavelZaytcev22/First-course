...
void VertexSettingsWindow(Vert*& Vert, const std::vector<EdgeL*>& EdgeDrawingQueue, Graph<int>& G)
{
	...
	RenderWindow VertexSettings(VideoMode(400, 50), L"Write name vertex", Style::Close | Style::Titlebar);
...
void EdgeSettingsWindow(EdgeL*& Edge, Graph<int>& G, std::vector<EdgeL*> EdgeDrawingQueue)
{
	...
	RenderWindow EdgeSettings(VideoMode(400, 50), L"Write name Edge", Style::Close | Style::Titlebar);
