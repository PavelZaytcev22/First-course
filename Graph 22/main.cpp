...
int main()
{
	...
	RenderWindow Window(VideoMode(800, 600), L"Mainwindow");
	Window.setVerticalSyncEnabled(true);
	int vi = 1;

	Button AddVertexBtn("Add vertex", Window.getSize(), 50);
	Button AddEdgeBtn("Add edge", Window.getSize(), 100);
	Button DelBtn("Delete", Window.getSize(), 150);

	Button SalesmanBtn("Commi", Window.getSize(), 1200);

	Button ApplyBtn("confirm", Window.getSize(), 300);
